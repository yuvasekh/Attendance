...
return(<div>
  ...
  <div class="bg-gridcolor  p-4 shadow-md h-[150px]  text-white text-center text-2xl" onClick={()=>{navigate('/addcourse')}}>No of Students</div>
  <div class="bg-gridcolor  p-4 shadow-md h-[150px] text-white text-center text-2xl" onClick={()=>{navigate('/addcourse')}}>No of Courses</div>
  ...
  <div class="bg-gridcolor  p-4 shadow-md h-[150px] text-white text-center text-2xl" onClick={()=>{navigate('/addcourse')}}>Make Attendance</div>
