...
import { Acorn,User } from 'lucide-react';
const DashBoard=()=>
{
...
return(<div>
  ...
  <div class="bg-gridcolor  p-4 shadow-md h-[150px]  text-white text-center text-2xl" onClick={()=>{navigate('/studentsList')}}>No of Students <User /></div>
